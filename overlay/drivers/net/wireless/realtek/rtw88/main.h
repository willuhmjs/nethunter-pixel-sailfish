...
/* NUM_NL80211_BANDS is already provided by this tree's backported cfg80211;
 * the usual pre-4.7 IEEE80211_NUM_BANDS fallback must not be used here.
 */
#if RTW_WIRELESS_VERSION_CODE < KERNEL_VERSION(4, 7, 0)
...
RTW_DECLARE_EWMA(evm, 10, 4);
RTW_DECLARE_EWMA(snr, 10, 4);
